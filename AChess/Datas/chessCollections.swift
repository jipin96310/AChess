...
public var chessCollectionsLevel = [
    ...
    [ //level3。 15个。   15
        ...
        chessStruct(name: EnumChessName.pagurian.rawValue.localized, desc: "", atkNum: 3, defNum: 1, chessRarity: 3, chessLevel: 1,chessKind: EnumChessKind.ocean.rawValue, abilities: [], temporaryBuff:[EnumAbilities.shell.rawValue], rattleFunc: [:], inheritFunc: [:]),
        chessStruct(name: EnumChessName.pagurian.rawValue.localized, desc: "", atkNum: 3, defNum: 1, chessRarity: 3, chessLevel: 1,chessKind: EnumChessKind.ocean.rawValue, abilities: [], temporaryBuff:[EnumAbilities.shell.rawValue], rattleFunc: [:], inheritFunc: [:]),
