...
public var chessCollectionsLevel = [
    ...
    [ //level3。 15个。   15
        ...
        chessStruct(name: EnumChessName.prawn.rawValue.localized, desc: "", atkNum: 1, defNum: 2, chessRarity: 3, chessLevel: 1,chessKind: EnumChessKind.ocean.rawValue, abilities: [EnumAbilities.endRoundAddBuff.rawValue], temporaryBuff:[], rattleFunc: [EnumKeyName.baseKind.rawValue : EnumChessKind.ocean.rawValue], inheritFunc: [:])
    ],
    [ //level4。 9个    12
