...
public var chessCollectionsLevel = [
    ...
    [ //level3。 15个。   15
        ...
        chessStruct(name: EnumChessName.quasipaa.rawValue.localized, desc: "", atkNum: 1, defNum: 7, chessRarity: 3, chessLevel: 1,chessKind: EnumChessKind.mountain.rawValue, abilities: [EnumAbilities.bait.rawValue], temporaryBuff:[EnumAbilities.shell.rawValue], rattleFunc: [:], inheritFunc: [:])
    ],
    [ //level4。 9个    12
